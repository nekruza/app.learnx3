"use client"
import { Box, Card, CardContent, CardHeader, Typography, Divider, List, ListItem, ListItemText, Button } from '@mui/material';
...
const Presentation = () => {
  ...
  return (
    ...
    <Box sx={{ padding: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, height: '100vh', overflowY: 'auto' }}>
      <CardHeader
        title={
      ...
      <CardContent>
        ...
        {presentationContent?.slides?.map((slide: any, index: number) => (
          <Box key={index} sx={{ marginBottom: 4, maxHeight: '600px' }}>
            <SlideCard>
              <CardContent sx={{
                display: 'flex',
                gap: 1,
                ...
                <Box sx={{
                  ...
                  <Box sx={{
                    ...
                    <Box sx={{
                      ...
                      {slide.content.for_teacher_closing && (
                        <Slide title="Teacher Closing" content={slide.content.for_teacher_closing} />
                      )}
                    </Box>
                    {index === 1 && <Box sx={{
                      display: 'flex',
